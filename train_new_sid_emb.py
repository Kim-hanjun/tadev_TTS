...
def main_worker(rank, n_gpus, hps):
    ...
    net_g = utils.init_new_sid_emb_g(net_g, hps.new_sid.new_n_speakers)
    ...
    optim_d = torch.optim.AdamW(net_d.parameters(), hps.train.learning_rate * hps.train.disc_lr_ratio, betas=hps.train.betas, eps=hps.train.eps)
