...
NEW_EMB_CHECKPOINT_FILENAME = "/home/hun/workspace/tadev-TTS/logs/new_sid_emb/G_59000.pth"
...
def main_worker(rank, n_gpus, hps):
    ...
    net_g = utils.expand_emb_g_with_new_emb_weight(net_g, NEW_EMB_CHECKPOINT_FILENAME)
